...
{
    public partial class PartTimeStudentForm : Form
    {
        public PartTimeStudentForm()
        {
            InitializeComponent();
        }
        ...
        private void cmptGrade_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                PartTimeStudent student = new PartTimeStudent(fname_txt.Text, lname_txt.Text, ssn_txt.Text,
