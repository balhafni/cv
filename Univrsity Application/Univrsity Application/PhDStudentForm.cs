...
{
    public partial class PhDStudentForm : Form
    {
        public PhDStudentForm()
        {
            InitializeComponent();
        }
        ...
        private void cmptGrade_btn_Click(object sender, EventArgs e)
        {
            ...
            {
                PhDStudent student = new PhDStudent(fname_txt.Text, lname_txt.Text, id_txt.Text, advisor_txt.Text,
                   phone_txt.Text, strt_txt.Text, city_txt.Text, Double.Parse(test1_txt.Text), Double.Parse(test2_txt.Text));
        ...
        private void test1_txt_TextChanged(object sender, EventArgs e)
        {
